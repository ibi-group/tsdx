# IBI Group TSDX
As the main TSDX is no longer being maintained, this is a forked version. Initially this has been done only to upgrade eslint and add a commit command. Dependencies have been updated to allow our eslint config to work.
